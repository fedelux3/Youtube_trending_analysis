...
La prima infografica mostra come la distribuzione dei video nelle varie categorie sia cambiata. Ad esempio, per quanto riguarda l'Italia la categoria di Sport subisce una drastica diminuzione, presumibilmente dovuta al blocco di tutte le attività sportive durante la quarantena; così come la categoria News \& politics che risulta essere più presente nel periodo Covid rispetto al precedente.
...
Da queste due infografiche possiamo concludere che i gusti degli utenti di Youtube hanno subito un evidente cambiamento durante il periodo dell'epidemia, e che questo mutamento è avvenuto gradualmente e non necessariamente legato al numero ufficiale dei contagi.
...
Ulteriori analisi potrebbero essere svolte su altre piattaforme, per avere un quadro più generale dei movimenti online che la pandemia ha generato. In tal modo sarebbe possibile comprendere come i gusti delle persone sono cambiati, o come il tempo a casa abbiamo cambiato gli interessi.

Un'ultima considerazione andrebbe fatta riguardo alla fase 2 e oltre, per verificare se i cambiamenti che sono avvenuti saranno definitivi oppure è stato solo un periodo unico.
