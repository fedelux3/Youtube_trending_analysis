...
\begin{figure}[H]
   \includegraphics[width=0.475\textwidth]{../quality/risposte_box_plot_first.png}
   \hfill
   \includegraphics[width=0.475\textwidth]{../quality/risposte_box_plot_second.png}
\end{figure}
...
\begin{figure}[H]
   ...
   \caption{$R_1^2 = 0.82, R_2^2 = 0.76$}
\end{figure}

La correlazione tra le variabili sono le seguenti:
\begin{figure}[H]
